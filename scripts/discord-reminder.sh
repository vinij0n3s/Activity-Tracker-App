#!/bin/bash
# Discord reminder script - sends a reminder every 6 days
...
echo "Sending Discord reminder at $(date)"
curl -X POST "https://${PROJECT_ID}.supabase.co/functions/v1/make-server-7c33a2a7/discord-reminder" \
  -H "Authorization: Bearer ${ANON_KEY}" \
  -H "Content-Type: application/json"
echo ""
echo "Discord reminder completed"
